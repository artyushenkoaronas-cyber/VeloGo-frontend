    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 max-w-[400px] mx-auto px-4 pb-6 z-10">
        ...
        <div className="flex items-center gap-2 mb-2">
          <button onClick={() => navigate(short.uploader?.username ? `/c/${short.uploader.username}` : `/c/${short.uploader?._id}`)}>
          ...
          <div className="flex items-center gap-1 flex-wrap">
            <button
              onClick={() => navigate(short.uploader?.username ? `/c/${short.uploader.username}` : `/c/${short.uploader?._id}`)}
              ...
              <>
                ...
                {short.collaborators.map((c, i) => (
                  <span key={c._id} className="flex items-center gap-0.5">
                    <button onClick={() => navigate(c.username ? `/c/${c.username}` : `/c/${c._id}`)} className="text-white text-sm font-semibold hover:opacity-80 transition">@{c.username || c.name}</button>
