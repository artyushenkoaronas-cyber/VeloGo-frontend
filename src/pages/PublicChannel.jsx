      ...
      <main className={`pt-14 transition-all duration-200 ${sidebarOpen ? 'ml-60' : 'ml-16'}`}>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            {channel?.website && (
              <a href={channel.website.startsWith('http') ? channel.website : `https://${channel.website}`}
                target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 bg-zinc-800 hover:bg-zinc-700 text-white px-5 py-2.5 rounded-full text-sm font-medium transition">
